...
for i in 1 2; do
  ...
  mkdir -p /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/h2o-2.2/amzn${i}/x86_64/
  mkdir -p /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/h2o-2.2/amzn${i}/src/
  cp -f amzn${i}.build/RPMS/x86_64/h2o-*.rpm /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/h2o-2.2/amzn${i}/x86_64/
  createrepo /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/h2o-2.2/amzn${i}/x86_64/
  cp -f amzn${i}.build/SRPMS/h2o-*.rpm /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/h2o-2.2/amzn${i}/src/
  createrepo /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/h2o-2.2/amzn${i}/src/
done
