...
for i in 7 6; do
  ...
  cp -f centos${i}.build/RPMS/x86_64/h2o-*.rpm /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/el${i}/x86_64/h2o/
  createrepo /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/el${i}/x86_64/

  cp -f centos${i}.build/SRPMS/h2o-*.rpm /var/www/sites/fetus.jp/rpm.fetus.jp/public_html/el${i}/src/h2o/
